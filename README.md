...
You can now proceed by pressing the big green button *"Clone or download"* located on the top right corner of the page and selecting *"Download ZIP"*. You'll now have all the file to run the program. Following this you'll just need to create your exchange and edit the config file.
