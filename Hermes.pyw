...
token = config_handler("Hermes_Bot_Token:", "Hermes 2 Exchange:", config_file)
URL = "https://api.telegram.org/bot{}/".format(token)
bot = telebot.TeleBot(token=token)
From_Hermes_Config = list(config_handler("Hermes 2 Exchange:", "Exchange 2 Hermes:", config_file).split("\n"))
To_Hermes_Config = list(config_handler("Exchange 2 Hermes:", "Hermes Chat History File:", config_file).split("\n"))
History = config_handler("Hermes Chat History File:", "End of Config", config_file)
